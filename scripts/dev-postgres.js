  ...
  try {
    ...
    const postgresEnv = {
      ...
      REVIEWPOINT_FEATURES:
        "auth:register,auth:login,auth:logout,auth:refresh_token,auth:request_password_reset,auth:reset_password,auth:me,health:read",
    ...
    backend.stdout.on("data", (data) =>
      logger.logOutput("BACKEND", colors.backend, data),
    );
    ...
    frontend.stdout.on("data", (data) =>
      logger.logOutput("FRONTEND", colors.frontend, data),
    );
