...
class TestIsolationDiagnostic:
    ...
    def run_single_test(self, test_path: str, test_name: str = None) -> TestResult:
    ...
    def run_test_group(self, test_paths: List[str], group_name: str = "group") -> TestResult:
    ...
    def generate_diagnostic_report(self) -> str:
            ...
            if not result.passed:
                ...
                for i, line in enumerate(lines):
                    if any(keyword in line.lower() for keyword in 
                          ['error', 'fail', 'exception', 'traceback', 'assert']):
        ...
        if individual_passed and group_failed:
            ...
            report.append("  1. Hardcoded test data (emails, usernames) causing conflicts")
...
def main():
    ...
    try:
        ...
        results = diagnostic.diagnose_auth_isolation_issue()
        ...
        if failed_tests > 0:
            ...
            print("Check the diagnostic report for detailed analysis and recommendations.")
        else:
