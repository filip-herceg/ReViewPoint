...
class TestDataGenerator:
    ...
    def __init__(self, test_prefix: Optional[str] = None):
        """
        ...
        self.unique_id = str(uuid.uuid4())[:8]  # Short unique ID for this generator instance
        self._user_counter = 0
        
    def generate_unique_email(self, role: Optional[str] = None) -> str:
        """
    ...
    def generate_test_user(self, 
                          ...
                          name_prefix: Optional[str] = None) -> TestUser:
        """
    ...
    def generate_multiple_users(self, count: int, role_prefix: Optional[str] = None) -> List[TestUser]:
        """
...
def get_unique_email(test_name: Optional[str] = None, role: Optional[str] = None) -> str:
    """Quick function to get a unique email."""
    generator = TestDataGenerator(test_name)
    return generator.generate_unique_email(role)


def get_test_user(test_name: Optional[str] = None, role: Optional[str] = None) -> TestUser:
    """Quick function to get a unique test user."""
    generator = TestDataGenerator(test_name)
    return generator.generate_test_user(role=role)


def get_unique_string(prefix: str = "test", test_name: Optional[str] = None) -> str:
