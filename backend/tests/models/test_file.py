...
class TestFileModel(AsyncModelTestTemplate):
    ...
    async def test_file_model_fields(self) -> None:
        ...
        """
        user: Final[User] = User(email="fileuser@example.com", hashed_password="hashed", is_active=True)
    ...
    async def test_file_crud(self) -> None:
        ...
        """
        user: Final[User] = User(email="cruduser@example.com", hashed_password="hashed", is_active=True)
        await self._seed_db_typed([user])
    ...
    async def test_file_user_relationship(self) -> None:
        ...
        """
        user: Final[User] = User(email="reluser@example.com", hashed_password="hashed", is_active=True)
        await self._seed_db_typed([user])
    ...
    async def test_bulk_insert_and_truncate(self) -> None:
        ...
        """
        user: Final[User] = User(email="bulkuser@example.com", hashed_password="hashed", is_active=True)
        await self._seed_db_typed([user])
    ...
    async def test_transactional_rollback(self) -> None:
        ...
        """
        user: Final[User] = User(email="rollbackuser@example.com", hashed_password="hashed", is_active=True)
        await self._seed_db_typed([user])
    ...
    async def test_file_repr(self) -> None:
        ...
        """
        user: Final[User] = User(email="repruser@example.com", hashed_password="hashed", is_active=True)
        await self._seed_db_typed([user])
    ...
    async def test_duplicate_filename_same_user(self) -> None:
        ...
        """
        user: Final[User] = User(email="dupuser@example.com", hashed_password="hashed", is_active=True)
        await self._seed_db_typed([user])
    ...
    async def test_long_filename_and_content_type(self) -> None:
        ...
        """
        user: Final[User] = User(email="longuser@example.com", hashed_password="hashed", is_active=True)
        await self._seed_db_typed([user])
    ...
    async def test_null_filename(self) -> None:
        ...
        """
        user: Final[User] = User(email="nullfname@example.com", hashed_password="hashed", is_active=True)
        await self._seed_db_typed([user])
