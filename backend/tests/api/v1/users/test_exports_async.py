...
class TestUserExportsAsync(ExportEndpointTestTemplate):
    @pytest.mark.asyncio
    async def test_export_users_csv(self, async_client: AsyncClient, override_env_vars, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_export_users_csv_unauthenticated(self, async_client: AsyncClient, override_env_vars, monkeypatch):
