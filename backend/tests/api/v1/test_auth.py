...
@pytest.mark.asyncio
async def test_register_unexpected_error(async_session: AsyncSession) -> None:
...
@pytest.mark.asyncio
def test_login_unexpected_error(async_session: AsyncSession) -> None:
...
@pytest.mark.asyncio
async def test_refresh_token_unexpected_error(async_session: AsyncSession) -> None:
