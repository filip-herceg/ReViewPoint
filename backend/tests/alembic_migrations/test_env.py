...
# Import env module only when needed to avoid SQLAlchemy model issues
...
class TestAlembicEnv(AlembicEnvTestTemplate):
    ...
    def reset_logger_handlers(self) -> Generator[None, None, None]:
        ...
        # Import here to avoid SQLAlchemy model loading issues
    ...
    def _make_context(
        ...
        """
        Create a fake Alembic context for testing.
        ...
        Returns:
            A SimpleNamespace object mocking the Alembic context
        """
        # Define typed callback functions
        get_main_option_func: Callable[[str], str | None] = lambda key: (
            url if key == "sqlalchemy.url" else None
        )
        get_section_func: Callable[[str], dict[str, object]] = lambda s: {}
        
        fake_context: types.SimpleNamespace = types.SimpleNamespace()
    ...
    def test_run_migrations_online_success(
        ...
        # Define properly typed lambda to suppress linting warnings
        ...
        def fake_engine_from_config(
            ...
            """Mock engine_from_config function that returns a mock engine."""
            return mock_engine
    ...
    def test_run_migrations_online_no_url(
        ...
        def fake_engine_from_config(
            ...
            """Mock engine_from_config that returns a mock engine."""
            return mock.Mock(
        ...
        typed_engine_factory: EngineFromConfigType = fake_engine_from_config
        self.assert_raises(
            ValueError, env.run_migrations_online, typed_engine_factory
        )

    # --- Begin migrated tests from test_alembic_env.py ---
    def test_run_migrations_offline_configure_raises(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_run_migrations_offline_handles_missing_url(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_run_migrations_online_happy_path(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        # Create a properly typed engine factory function
        def typed_engine_factory(configuration: object, prefix: str, poolclass: object | None) -> mock.MagicMock:
            return mock_engine
    ...
    def test_run_migrations_online_missing_url(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_run_migrations_online_engine_connect_raises(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_run_migrations_offline_configures_logging(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_run_migrations_online_configures_logging(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_run_migrations_offline_fileConfig_raises(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_run_migrations_offline_begin_transaction_raises(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_run_migrations_offline_run_migrations_raises(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_run_migrations_online_engine_from_config_raises(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        def engine_from_config(configuration: object, prefix: str, poolclass: object | None) -> mock.MagicMock:
    ...
    # --- End migrated tests ---
    def test_env_py_configures_context_with_postgres_url(self, monkeypatch: pytest.MonkeyPatch) -> None:
