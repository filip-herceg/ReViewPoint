...
test.describe('Authentication Flow', () => {
  ...
  test('complete registration and login flow', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="welcome-message"]')).toContainText('newuser')
  })
  ...
  test('redirects to login when accessing protected route', async ({ page }) => {
    ...
    // Should redirect to login
    await expect(page).toHaveURL('/login')
    await expect(page.locator('[data-testid="redirect-message"]')).toBeVisible()
  })
})
```
...
test.describe('File Upload', () => {
  ...
  test('uploads file successfully', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="file-list"]')).toContainText('test.txt')
