...
describe('uiStore', () => {
    ...
    it('should set theme', () => {
        ...
        testLogger.debug('Theme after setTheme("dark")', useUIStore.getState().theme)
        expect(useUIStore.getState().theme).toBe('dark')
        useUIStore.getState().setTheme('light')
        testLogger.debug('Theme after setTheme("light")', useUIStore.getState().theme)
    ...
    it('should toggle sidebar', () => {
        ...
        testLogger.debug('Sidebar open after first toggle', useUIStore.getState().sidebarOpen)
        expect(useUIStore.getState().sidebarOpen).toBe(true)
        useUIStore.getState().toggleSidebar()
        testLogger.debug('Sidebar open after second toggle', useUIStore.getState().sidebarOpen)
    ...
    it('should add and remove notifications', () => {
        ...
        testLogger.debug('Notifications after adding', useUIStore.getState().notifications)
        ...
        testLogger.debug('Notifications after removing first', useUIStore.getState().notifications)
