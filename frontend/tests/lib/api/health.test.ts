...
describe('Health API', () => {
    ...
    describe('getHealth', () => {
        ...
        it('should fetch health status successfully', async () => {
            ...
            expect(mockLogger.info).toHaveBeenCalledWith('Health status retrieved successfully', { 
        ...
        it('should handle error response from API', async () => {
            ...
            expect(mockLogger.warn).toHaveBeenCalledWith('Failed to get health status', { 
                error: errorMessage 
            });
        });
...
db_pool_awaiting 0`;
        ...
        it('should fetch metrics successfully', async () => {
            ...
            expect(mockLogger.info).toHaveBeenCalledWith('Fetching application metrics');
            expect(mockLogger.info).toHaveBeenCalledWith('Metrics retrieved successfully');
        ...
        it('should handle network errors', async () => {
            ...
            await expect(healthApi.getMetrics()).rejects.toThrow('Connection refused');
