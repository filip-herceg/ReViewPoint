...
function createBrowserFile(name = 'test.pdf', type = 'application/pdf', size = 1024): globalThis.File {
...
describe('Upload Types', () => {
    ...
    describe('Utility Functions', () => {
        ...
        describe('isValidFileSize', () => {
            it('should validate file sizes correctly', () => {
                ...
                const largeFile = createBrowserFile('large.txt', 'text/plain', 5 * 1024 * 1024);
        ...
        describe('createUploadFromFile', () => {
            it('should create upload objects from browser files', () => {
                const browserFile = createBrowserFile('test.pdf', 'application/pdf', 1024000);
    ...
    describe('Constants', () => {
        ...
        describe('FILE_TYPE_CATEGORIES', () => {
            it('should categorize file types correctly', () => {
                expect(FILE_TYPE_CATEGORIES.DOCUMENT).toContain(SUPPORTED_FILE_TYPES.PDF);
                expect(FILE_TYPE_CATEGORIES.IMAGE).toContain(SUPPORTED_FILE_TYPES.JPEG);
                expect(FILE_TYPE_CATEGORIES.ARCHIVE).toContain(SUPPORTED_FILE_TYPES.ZIP);
