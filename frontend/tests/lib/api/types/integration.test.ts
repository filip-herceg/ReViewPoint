...
describe('API Types Integration Tests', () => {
    ...
    describe('Upload Store Integration', () => {
        it('should handle upload fetching with proper types', async () => {
            ...
            expect(state.uploads.every(u => u.id && u.name && u.status === 'completed')).toBe(true);
        ...
        it('should handle upload update', async () => {
            ...
            const originalUpload = createApiUpload({ id: '1', name: 'original.pdf', progress: 50 });
            const updatedUpload = { ...originalUpload, progress: 100, status: 'completed' as const };
        ...
        it('should handle API errors gracefully', async () => {
            ...
            vi.mocked(uploadsApi.listFiles).mockRejectedValue(new Error(errorMessage));
    ...
    describe('Error Handling Edge Cases', () => {
        ...
        it('should handle invalid store operations', () => {
            ...
            expect(() => uploadStore.setCurrentUpload({ id: '', name: '' } as any)).toThrow();
