...
describe('API Integration with Token Refresh', () => {
    ...
    describe('Token Service Integration', () => {
        it('should provide valid token when requested', async () => {
            ...
            vi.mocked(tokenService.getValidAccessToken).mockResolvedValue(tokens.access_token);
        ...
        it('should handle token refresh when token is expired', async () => {
            ...
            vi.mocked(tokenService.refreshAccessToken).mockResolvedValue(newTokens.access_token);
            vi.mocked(tokenService.getValidAccessToken).mockResolvedValue(newTokens.access_token);
        ...
        it('should handle token refresh failure', async () => {
            ...
            vi.mocked(tokenService.getValidAccessToken).mockRejectedValue(new Error('Token refresh failed'));

            await expect(tokenService.getValidAccessToken()).rejects.toThrow('Token refresh failed');
    ...
    describe('Error Handling Integration', () => {
        it('should handle authentication errors gracefully', async () => {
            ...
            await expect(tokenService.getValidAccessToken()).rejects.toThrow('Authentication failed');
        ...
        it('should handle network errors during token refresh', async () => {
            ...
            await expect(tokenService.refreshAccessToken()).rejects.toThrow('Network error');
