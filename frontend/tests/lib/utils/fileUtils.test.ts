...
function createTestFileList(count: number = 3): string[] {
...
describe('fileUtils', () => {
    ...
    describe('generateUniqueFilename', () => {
        it('should return original name if unique', () => {
            ...
            expect(generateUniqueFilename('new-file.txt', existingFiles)).toBe('new-file.txt');
        });
    ...
    describe('validateFilename', () => {
        ...
        it('should warn about unicode characters', () => {
            ...
            expect(result.warnings).toContain('Filename contains non-ASCII characters');
        });
    });
    ...
    describe('isPreviewSupported', () => {
        ...
        it('should use MIME type when provided', () => {
            ...
            expect(isPreviewSupported('unknown.xyz', 'application/octet-stream')).toBe(false);
        });
    });
