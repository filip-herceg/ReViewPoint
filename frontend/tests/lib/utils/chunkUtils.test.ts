...
function createTestProgress(options: Partial<ChunkUploadProgress> = {}): ChunkUploadProgress {
...
describe('chunkUtils', () => {
    ...
    describe('createChunkHash', () => {
        it.skip('should generate hash for chunk', async () => {
            ...
            testLogger.info('Skipping chunk hash test due to test environment limitations');
        });
    });
    ...
    describe('verifyChunk', () => {
        it.skip('should verify chunk against hash', async () => {
            // Skipped: Crypto API limitations in test environment
            testLogger.info('Skipping chunk verification test due to test environment limitations');
        });
    });
    ...
    describe('calculateUploadMetrics', () => {
        it('should calculate upload metrics', () => {
            ...
            const metrics = calculateUploadMetrics(chunks, uploadedChunks, failedChunks);
