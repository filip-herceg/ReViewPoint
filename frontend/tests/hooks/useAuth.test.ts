...
describe('useAuth Hook', () => {
    ...
    describe('login', () => {
        ...
        it('should handle login errors', async () => {
            ...
            await act(async () => {
                await expect(result.current.login(loginRequest)).rejects.toThrow(error.message);
            });
        ...
        it('should handle invalid token response', async () => {
            ...
            await act(async () => {
                await expect(result.current.login(loginRequest)).rejects.toThrow('Invalid authentication response');
            });

            expect(mockStore.setError).toHaveBeenCalledWith('Invalid authentication response');
        });
    });
    ...
    describe('register', () => {
        ...
        it('should handle registration errors', async () => {
            ...
            await act(async () => {
                await expect(result.current.register(registerRequest)).rejects.toThrow(error.message);
            });
    ...
    describe('forgotPassword', () => {
        ...
        it('should handle forgot password errors', async () => {
            ...
            await act(async () => {
                await expect(result.current.forgotPassword(email)).rejects.toThrow(error.message);
            });
    ...
    describe('resetPassword', () => {
        it('should reset password successfully', async () => {
            ...
            mockAuthApi.resetPassword.mockResolvedValue({ message: 'Password reset' });
        ...
        it('should handle reset password errors', async () => {
            ...
            await act(async () => {
                await expect(result.current.resetPassword(token, newPassword)).rejects.toThrow(error.message);
            });
    ...
    describe('refreshSession', () => {
        ...
        it('should handle refresh failure', async () => {
            ...
            mockTokenService.refreshAccessToken.mockRejectedValue(new Error('Refresh failed'));
