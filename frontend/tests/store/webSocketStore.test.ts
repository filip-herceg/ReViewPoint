...
import { webSocketService, type WebSocketEventType } from '@/lib/websocket/webSocketService';
import { createTestError, createTestNotification, createTestUploadProgress } from '../test-templates';
...
describe('WebSocketStore', () => {
    ...
    describe('connection management', () => {
        ...
        it('should subscribe to events', () => {
            ...
            const events: WebSocketEventType[] = ['upload.progress', 'system.notification'];
