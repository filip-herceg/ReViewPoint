...
import { createUploadList, clearReactQueryCache } from '../test-templates'
...
describe('UploadList component', () => {
    ...
    it('shows error state', () => {
        ...
        act(() => {
            ...
            useUploadStore.setState({ error: { type: 'unknown', message: 'fail' }, loading: false })
        })
        render(<UploadList disableAutoFetch />)
    ...
    it('shows empty state', () => {
        ...
        act(() => {
            testLogger.debug('Setting uploads=[] and loading=false, error=null in store')
    ...
    it('shows uploads', () => {
        ...
        uploads.forEach((upload) => {
            testLogger.debug(`Checking for upload name: ${upload.name} and status: ${upload.status}`)
    ...
    it('shows store error for non-Error values (object, number)', () => {
        act(() => {
            useUploadStore.setState({ error: { message: 'Obj error' } as any, loading: false });
        });
