...
import { createTestConnectionMetadata } from '../../test-templates';
...
vi.mock('lucide-react', () => ({
    ...
    WifiOffIcon: ({ className }: { className?: string }) => <div data-testid="wifi-off-icon" className={className} />,
    LoaderIcon: ({ className }: { className?: string }) => <div data-testid="loader-icon" className={className} />,
    AlertTriangleIcon: ({ className }: { className?: string }) => <div data-testid="alert-triangle-icon" className={className} />,
...
describe('WebSocketStatus', () => {
    ...
    describe('details display', () => {
        it('should show connection details when showDetails is true', () => {
            ...
            expect(screen.getByText('test-connection-123'.slice(0, 8) + '...')).toBeInTheDocument();
            expect(screen.getByText('Connected:')).toBeInTheDocument();
        });
    ...
    describe('styling', () => {
        it('should apply custom className', () => {
            const { container } = render(<WebSocketStatus className="custom-class" />);
...
describe('WebSocketIndicator', () => {
    ...
    it('should apply custom className', () => {
        const { container } = render(<WebSocketIndicator className="custom-indicator" />);
