...
import { createTestError, createUploadFormData } from "../test-templates";
...
function renderUploadFormWithStore(
	...
	const _store = setupUseUploadStoreMock(storeOverrides);
...
describe("UploadForm", () => {
	...
	it("shows local error on createUpload rejection", async () => {
		const _store = setupUseUploadStoreMock({
