...
const mockUseFileManagementStore = useFileManagementStore as unknown as ReturnType<typeof vi.fn>;
...
describe('FileManagementDashboard', () => {
    ...
    describe('Basic Rendering', () => {
        ...
        it('should render loading state correctly', () => {
            ...
            const cardContent = screen.getAllByText(/File Management/)[0]?.closest('div');
        ...
        it('should render error state correctly', () => {
            const error = { message: 'Network connection failed', type: 'network_error' as const };
            mockUseFileManagementStore.mockReturnValue({
                ...mockStoreState,
                error,
                loading: false,
    ...
    describe('File Selection', () => {
        const mockFiles = [
            createTestFileItem({ filename: 'selectable1.pdf', createdAt: '2025-07-04T10:00:00Z' }),
            createTestFileItem({ filename: 'selectable2.jpg', createdAt: '2025-07-02T10:00:00Z' }),
            createTestFileItem({ filename: 'selectable3.docx', createdAt: '2025-07-02T09:00:00Z' }),
        ];
        ...
        it('should show bulk actions when files are selected', () => {
            ...
            const bulkDeleteButton = screen.getAllByRole('button', { name: /^delete$/i })
    ...
    describe('File Actions', () => {
        ...
        it('should handle file deletion with confirmation', async () => {
            const user = userEvent.setup();
            mockStoreState.deleteFile.mockResolvedValue({ success: true, filename: 'actionable.pdf' });
            ...
            await waitFor(() => {
                expect(mockStoreState.deleteFile).toHaveBeenCalledWith('actionable.pdf');
            });
