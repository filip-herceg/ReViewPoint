...
describe('AriaLiveRegion Component', () => {
    ...
    it('disables auto-clear when clearDelay is 0', () => {
        ...
        render(
            <AriaLiveRegion message="Persistent message" clearDelay={0} />
        );
...
describe('useAriaLive Hook', () => {
    const TestComponent = ({ defaultPoliteness }: { defaultPoliteness?: any }) => {
        const { message, politeness, announce, announcePolite, announceAssertive, clear } = useAriaLive(defaultPoliteness);
...
describe('StatusAnnouncer Component', () => {
    it('formats status messages correctly', () => {
        ...
        rerender(<StatusAnnouncer status="success" message="Operation completed" />);
        ...
        rerender(<StatusAnnouncer status="info" message="Additional information" />);
        expect(screen.getByText('Info: Additional information')).toBeInTheDocument();
    });
...
describe('FormValidationAnnouncer Component', () => {
    it('announces single error correctly', () => {
        ...
        expect(screen.getByText('email field: This field is required')).toBeInTheDocument();
    });
    ...
    it('announces multiple errors correctly', () => {
        ...
        expect(screen.getByText('password field: 2 errors: Field is required, Invalid format')).toBeInTheDocument();
    });
    ...
    it('handles no field name', () => {
        ...
        expect(screen.getByText('Validation error: Validation error')).toBeInTheDocument();
    });
