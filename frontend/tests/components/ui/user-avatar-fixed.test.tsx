...
import { UserAvatar, AvatarGroup, useUserAvatar } from '@/components/ui/user-avatar';
...
describe('UserAvatar Component', () => {
    ...
    it('shows online status when enabled', () => {
        ...
        const apiUser = createUser({ name: 'Test User', email: 'test@example.com' });
        const user = toAvatarUser(apiUser);
    ...
    it('generates unique background colors based on user data', () => {
        ...
        const element1 = container1.querySelector('[data-testid="avatar-initials"]');
        const element2 = container2.querySelector('[data-testid="avatar-initials"]');
...
describe('AvatarGroup Component', () => {
    ...
    it('shows all users when max is set to a large number', () => {
        ...
        const apiUsers = Array.from({ length: 10 }, (_, i) => {
            const names = ['Alice Brown', 'Bob Chen', 'Carol Davis', 'David Evans', 'Eva Frank',
                'Frank Green', 'Grace Hill', 'Henry Johnson', 'Ivy Kumar', 'Jack Liu'];
        ...
        const expectedInitials = ['AB', 'BC', 'CD', 'DE', 'EF', 'FG', 'GH', 'HJ', 'IK', 'JL'];
