...
describe('AuthGuard Components', () => {
    ...
    describe('AuthGuard', () => {
        ...
        it('renders fallback when user lacks required roles', () => {
            ...
            render(
                <AuthGuard requireAnyRole={['admin']} fallback={<div data-testid="access-denied">Access Denied</div>}>
                    <div data-testid="protected-content">Protected Content</div>
                </AuthGuard>
            );
    ...
    describe('RequireAuth', () => {
        ...
        it('renders fallback when not authenticated', () => {
            ...
            render(
                <RequireAuth fallback={<div data-testid="login-prompt">Please Login</div>}>
                    <div data-testid="auth-content">Authenticated Content</div>
                </RequireAuth>
            );
    ...
    describe('RequireRole', () => {
        ...
        it('renders fallback when user lacks required role', () => {
            ...
            render(
                <RequireRole role="admin" fallback={<div data-testid="no-access">No Access</div>}>
                    <div data-testid="admin-content">Admin Content</div>
                </RequireRole>
            );
    ...
    describe('RequireAnyRole', () => {
        ...
        it('renders fallback when user has none of the required roles', () => {
            ...
            render(
                <RequireAnyRole roles={['admin', 'moderator']} fallback={<div data-testid="insufficient-role">Insufficient Role</div>}>
                    <div data-testid="mod-content">Moderation Content</div>
                </RequireAnyRole>
            );
    ...
    describe('RequireAllRoles', () => {
        ...
        it('renders fallback when user is missing any required role', () => {
            ...
            render(
                <RequireAllRoles roles={['admin', 'superuser']} fallback={<div data-testid="missing-role">Missing Role</div>}>
                    <div data-testid="super-admin-content">Super Admin Content</div>
                </RequireAllRoles>
            );
    ...
    describe('RequireUnauthenticated', () => {
        ...
        it('renders fallback when user is authenticated', () => {
            ...
            render(
                <RequireUnauthenticated fallback={<div data-testid="already-logged-in">Already Logged In</div>}>
                    <div data-testid="guest-content">Guest Content</div>
                </RequireUnauthenticated>
            );
