  ...
  rules: {
    ...
    'no-restricted-syntax': [
      'error',
      {
        ...
        message: 'Use the Button component from @/components/ui/button instead of raw <button> elements. See BUTTON_STANDARDS.md for guidelines.'
      }
    ],
...
const buttonAsChildRule = {
  meta: {
    type: 'problem',
    docs: {
      description: 'Button with asChild prop must have exactly one child element',
      category: 'Possible Errors',
      recommended: true
    },
    messages: {
      multipleChildren: 'Button with asChild prop must have exactly one child element. Wrap multiple elements in a single container.',
      noChildren: 'Button with asChild prop must have exactly one child element.'
    }
  },
