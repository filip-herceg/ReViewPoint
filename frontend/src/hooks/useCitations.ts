...
const generateRealisticCitations = (documentId: string): CitationsData => {
  ...
  for (let i = 0; i < uniqueSources; i++) {
    ...
    if (rand < 0.5) timesUsed = 1;        // 50% cited once
    else if (rand < 0.8) timesUsed = 2;   // 30% cited twice  
    else if (rand < 0.95) timesUsed = 3;  // 15% cited 3 times
  ...
  return {
    citationsUsed: {
      ...
      documentCitations: citations.map(c => ({ id: c.id, citationId: c.id, documentId })), // For backward compatibility
...
const getCitationTemplates = (paperType: 'architecture' | 'medical' | 'business') => {
  const templates = {
    architecture: [
      { title: "Sustainable Building Design: A Global Perspective", authors: ["Johnson, M.K.", "Chen, L.Y."], journal: "Architectural Science Review", type: 'journal' as const },
      { title: "Urban Planning in the 21st Century", authors: ["Williams, R.A."], journal: "Urban Design International", type: 'book' as const },
      { title: "Green Architecture: Environmental Impact Assessment", authors: ["Davis, S.L.", "Miller, K.J."], journal: "Building and Environment", type: 'journal' as const },
      { title: "Smart Cities Integration Framework", authors: ["Kumar, A.", "Patel, N."], journal: "Smart Cities Journal", type: 'journal' as const },
      { title: "Climate-Responsive Design Principles", authors: ["Hassan, A.", "Okoye, C."], journal: "Sustainable Architecture", type: 'journal' as const },
      { title: "Biomimetic Architecture: Learning from Nature", authors: ["Thompson, D.W.", "Garcia, M.R."], journal: "Architectural Design", type: 'journal' as const },
      { title: "Parametric Design in Contemporary Architecture", authors: ["Rodriguez, C.", "Nakamura, H."], journal: "International Journal of Architectural Computing", type: 'journal' as const },
      { title: "Material Innovation in Construction", authors: ["Zhang, W.", "Andersson, L."], journal: "Construction and Building Materials", type: 'journal' as const }
    ],
    medical: [
      { title: "Clinical Trial Methodology: A Comprehensive Guide", authors: ["Smith, J.L.", "Brown, A.M."], journal: "The Lancet", type: 'journal' as const },
      { title: "Evidence-Based Medicine: Principles and Practice", authors: ["Wilson, T.R."], journal: "BMJ Evidence-Based Medicine", type: 'book' as const },
      { title: "AI in Diagnostic Imaging: Current Applications", authors: ["Garcia, M.P.", "Lee, H.K."], journal: "Nature Medicine", type: 'journal' as const },
      { title: "Patient Safety in Healthcare Systems", authors: ["Taylor, K.S.", "O'Brien, P."], journal: "Patient Safety", type: 'journal' as const },
      { title: "Personalized Medicine and Genomics", authors: ["Kumar, R.", "Singh, A."], journal: "Nature Genetics", type: 'journal' as const },
      { title: "Mental Health Treatment Outcomes", authors: ["Foster, L.J.", "Chen, X."], journal: "The Lancet Psychiatry", type: 'journal' as const },
      { title: "Surgical Innovation and Robotics", authors: ["Martinez, C.R.", "Tanaka, Y."], journal: "Surgical Endoscopy", type: 'journal' as const },
      { title: "Global Health Policy Analysis", authors: ["Ahmed, F.", "Clark, R."], journal: "Health Policy", type: 'journal' as const }
    ],
    business: [
      { title: "Strategic Management in Digital Transformation", authors: ["Anderson, P.K.", "Taylor, R.L."], journal: "Harvard Business Review", type: 'journal' as const },
      { title: "Market Analysis and Consumer Behavior", authors: ["Thompson, L.M."], journal: "Journal of Consumer Research", type: 'book' as const },
      { title: "Corporate Finance and Risk Management", authors: ["Roberts, K.J.", "White, J.S."], journal: "Journal of Finance", type: 'journal' as const },
      { title: "Digital Transformation Strategies", authors: ["Liu, Z.", "Murphy, E."], journal: "MIT Sloan Management Review", type: 'journal' as const },
      { title: "Supply Chain Optimization", authors: ["Davis, A.", "Patel, V."], journal: "Operations Research", type: 'journal' as const },
      { title: "Innovation Management in Technology Firms", authors: ["Chen, L.", "Rodriguez, S."], journal: "Research Policy", type: 'journal' as const },
      { title: "Sustainable Business Practices", authors: ["Green, M.K.", "Hoffman, B."], journal: "Business Strategy and Environment", type: 'journal' as const },
      { title: "International Trade Economics", authors: ["Wilson, J.P."], journal: "International Economics", type: 'journal' as const }
    ]
  };
