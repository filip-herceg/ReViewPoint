...
export interface ModuleCapabilities {
    ...
    analysisTypes: ('citation-validation' | 'plagiarism-check' | 'quality-assessment' | 'bias-detection' | 'methodology-review' | 'data-extraction' | 'formatting-check' | 'language-analysis' | 'statistical-validation')[];
...
export interface Module {
    ...
    icon: string;
    category: 'citation' | 'analysis' | 'formatting' | 'collaboration' | 'data' | 'security' | 'automation';
    tags: string[];
