...
const mockExecuteModule = async (moduleId: string, documentId: string): Promise<ModuleExecutionResult> => {
    ...
    const mockResults: Record<string, any> = {
        ...
        'plagiarism-detector': {
            ...
            confidence: 0.96,
            suggestions: [
                'Consider adding more original analysis in section 3'
            ],
            warnings: [],
            errors: []
        },
...
const getModuleIcon = (category: string) => {
    switch (category) {
        case 'citation': return BookCheck;
                        ...
                        <Card key={module.id} className="relative">
                            ...
                            <CardContent className="space-y-3">
                                ...
                                <div className="text-xs text-muted-foreground flex items-center gap-4">
                                    ...
                                    <span>
                                        Max {module.capabilities.maxFileSize}MB
                                    </span>
                                </div>
                                            ...
                                            <Alert className="mt-2">
                                                ...
                                                <AlertDescription className="text-sm">
                                                    ...
                                                    <ul className="list-disc list-inside mt-1">
                                                        {result.results.suggestions.slice(0, 2).map((suggestion, index) => (
                                                            <li key={index}>{suggestion}</li>
                                                        ))}
                                                    </ul>
                                                    {result.results.suggestions.length > 2 && (
                                                        <p className="text-xs text-muted-foreground mt-1">
                                                            +{result.results.suggestions.length - 2} more suggestions
                                                        </p>
                                                    )}
                                                </AlertDescription>
                                            </Alert>
