...
// Modal variant types
export type ModalVariant = 'default' | 'destructive' | 'warning' | 'success' | 'info';
...
export interface ConfirmModalProps extends Omit<ModalProps, 'variant' | 'onConfirm'> {
    onConfirm: () => void | Promise<void>;
    message?: string;
}
...
export interface DeleteModalProps extends Omit<ModalProps, 'variant' | 'onConfirm'> {
    onConfirm: () => void | Promise<void>;
    itemName?: string;
    message?: string;
}
...
export interface AlertModalProps extends Omit<ModalProps, 'variant' | 'onCancel' | 'onConfirm'> {
    message?: string;
    onClose?: () => void;
}
