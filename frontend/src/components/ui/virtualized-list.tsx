...
export function VirtualizedList<T>({
    ...
    }, [items.length, visibleItems.length, visibleRange, scrollTop, itemHeight, containerHeight]);
...
export function useVirtualizedList<T>(items: T[], options?: {
    ...
    const scrollToIndex = useCallback((index: number) => {
        ...
        logger.info('VirtualizedList: Scrolled to index', { index, scrollTop: targetScrollTop });
    }, [itemHeight]);
...
export function VirtualizedGrid<T>({
    ...
    // Get visible items
    const visibleItems = useMemo(() => {
        const result: Array<{ item: T; index: number; row: number; col: number; key: string | number }> = [];
