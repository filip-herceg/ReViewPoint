  ...
  const renderInput = () => {
    const inputProps = {
      ...
      className: cn(
        ...
        error &&
          "border-destructive focus-visible:ring-destructive bg-background text-foreground placeholder:text-muted-foreground",
        !error &&
        ...
        return (
          ...
          >
            <SelectTrigger
              ...
              className={cn(
                error &&
                  "border-destructive focus-visible:ring-destructive bg-background text-foreground",
