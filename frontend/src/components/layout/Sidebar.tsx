...
import { routes, RouteConfig } from '@/lib/router/routes';
                    ...
                    {mainRoute && (
                        <div className="p-4 border-b border-border">
                            <div className="flex items-center space-x-3">
                                {mainRoute.icon && iconMap[mainRoute.icon] && (
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">{mainRoute.description}</p>
                                </div>
                            </div>
                        </div>
                    )}
                            ...
                            {subRoutes.length > 0 && (
                                <>
                                    ...
                                    {subRoutes.map((subRoute) => {
                                        const isActive = currentPath === subRoute.path ||
                                            (subRoute.path !== '/' && currentPath.startsWith(subRoute.path));
