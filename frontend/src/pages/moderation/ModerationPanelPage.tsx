...
import { UserCheck, Flag, Eye, Shield, CheckCircle, XCircle, AlertTriangle } from 'lucide-react';
            ...
            <div className="space-y-6">
                ...
                <ShowForRoles roles={['admin']}>
                    <Alert>
                        <Shield className="h-4 w-4" />
                        <AlertDescription>
                            <strong>Admin Only:</strong> You have full moderation privileges including the ability to
                            permanently ban users and delete content.
                        </AlertDescription>
                    </Alert>
                </ShowForRoles>
                                    ...
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1">
                                            ...
                                            <div className="text-sm text-muted-foreground space-y-1">
                                                ...
                                                <div>
                                                    <strong>Reported:</strong> {new Date(item.reportedAt).toLocaleString()}
                                                </div>
                                            </div>
                                        </div>
