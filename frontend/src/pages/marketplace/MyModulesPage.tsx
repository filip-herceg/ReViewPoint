            ...
            <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
                    ...
                    <Card>
                        <CardContent className="p-4">
                            <div className="text-2xl font-bold">
                                {userSubscriptions.reduce((sum, s) => sum + s.usageStats.totalRuns, 0)}
                            </div>
                    ...
                    <Card>
                        <CardContent className="p-4">
                            <div className="text-2xl font-bold">
                                {userSubscriptions.filter(s => s.licenseType === 'premium').length}
                            </div>
                ...
                <Card>
                    <CardContent className="flex flex-col items-center justify-center py-12">
                        ...
                        <p className="text-muted-foreground text-center mb-6">
                            Browse the marketplace to discover and install powerful modules for your workflow
                        </p>
                        <Button asChild>
                            <Link to="/marketplace">
                                Browse Marketplace
                                            ...
                                            <div className="space-y-3">
                                                <div>
                                                    <div className="flex justify-between text-sm mb-1">
                                                        ...
                                                        <span className="font-medium">{subscription.usageStats.totalRuns}</span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div className="flex justify-between text-sm mb-1">
                                                        <span>Avg. Processing Time</span>
                                                        <span className="font-medium">{subscription.usageStats.averageProcessingTime}s</span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div className="flex justify-between text-sm mb-1">
                                        ...
                                        <div>
                                            ...
                                            <div className="space-y-3">
                                                            ...
                                                            <div className="mt-2">
                                                                <Progress 
                                                                    value={(() => {
                                                                        ...
                                                                        const start = new Date(subscription.subscribedAt).getTime();
                                                ...
                                                <div>
                                                    <div className="flex justify-between text-sm mb-1">
                                                        <span>Version</span>
                                                        <span className="font-medium">v{module.currentVersion}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
