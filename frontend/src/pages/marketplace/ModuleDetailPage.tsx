                ...
                <div className="lg:col-span-2">
                    <div className="flex items-start gap-4 mb-6">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                {module.featured && <Crown className="h-5 w-5 text-yellow-500" />}
                                {module.verified && <Verified className="h-5 w-5 text-blue-500" />}
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    {module.author.organization && (
                                        <div className="text-sm text-muted-foreground">{module.author.organization}</div>
                                    )}
                                </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        <div className="text-center">
                            ...
                            <div className="text-sm text-muted-foreground">{module.rating.count} reviews</div>
                        </div>
                        <div className="text-center">
                            <div className="flex items-center justify-center gap-1 mb-1">
                                <Download className="h-4 w-4" />
                                <span className="font-semibold">{module.downloads.toLocaleString()}</span>
                            </div>
                        ...
                        <div className="text-center">
                            <div className="flex items-center justify-center gap-1 mb-1">
                                ...
                                <span className="font-semibold">{formatFileSize(module.versions[0]?.size || 0)}</span>
                            </div>
                ...
                <div className="lg:col-span-1">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                {isSubscribed ? 'Module is installed' : 'Add this module to your toolkit'}
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            {isSubscribed ? (
                                <div className="space-y-4">
                                    ...
                                    {subscription && (
                                        <div className="space-y-2 text-sm">
                                            <div>License: <span className="font-medium capitalize">{subscription.licenseType}</span></div>
                                            {subscription.expiresAt && (
                                                <div>Expires: <span className="font-medium">
                                                    {new Date(subscription.expiresAt).toLocaleDateString()}
                                                </span></div>
                                            )}
                                            <div>Usage: <span className="font-medium">{subscription.usageStats.totalRuns} runs</span></div>
                                        </div>
                                    )}
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Button 
                                            ...
                                            disabled={installing}
                                        >
                                            {installing ? <LoadingSpinner size="sm" /> : <XCircle className="h-4 w-4 mr-2" />}
                                            Uninstall
                                        </Button>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        <div className="text-2xl font-bold">
                                            {formatPrice(module.license.price, module.license.currency)}
                                    ...
                                    <div className="space-y-2">
                                        {module.license.type === 'free' && (
                                            <Button 
                                                ...
                                                disabled={installing}
                                            >
                                                {installing ? <LoadingSpinner size="sm" /> : <Download className="h-4 w-4 mr-2" />}
                                                Install Free
                                            </Button>
                                        )}
                                        
                                        {(module.license.type === 'freemium' || module.license.type === 'paid') && (
                                            <>
                                                ...
                                                >
                                                    {installing ? <LoadingSpinner size="sm" /> : <Download className="h-4 w-4 mr-2" />}
                                                    {module.license.trialPeriod ? 'Start Free Trial' : 'Get Premium'}
                                                </Button>
                                            </>
                                        )}
                                        ...
                                        {module.license.type === 'subscription' && (
                                            ...
                                            >
                                                {installing ? <LoadingSpinner size="sm" /> : <Download className="h-4 w-4 mr-2" />}
                                                {module.license.trialPeriod ? 'Start Free Trial' : 'Subscribe'}
                                            </Button>
                                        )}
                                    </div>
                                    ...
                                    <div className="space-y-2 pt-4 border-t">
                                        {module.demoUrl && (
                                            <Button variant="ghost" size="sm" className="w-full" asChild>
                                                <a href={module.demoUrl} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <Button variant="ghost" size="sm" className="w-full" asChild>
                                            <a href={module.documentation} target="_blank" rel="noopener noreferrer">
                                        ...
                                        {module.sourceCodeUrl && (
                                            <Button variant="ghost" size="sm" className="w-full" asChild>
                                                <a href={module.sourceCodeUrl} target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Available with the free version</CardDescription>
                            </CardHeader>
                            <CardContent>
                ...
                <TabsContent value="reviews" className="mt-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                {module.rating.count} reviews • Average {module.rating.average}/5
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                {module.versions.map((version) => (
                                    <div key={version.version} className="border-l-2 border-muted pl-4">
                                        <div className="flex items-center gap-2 mb-2">
