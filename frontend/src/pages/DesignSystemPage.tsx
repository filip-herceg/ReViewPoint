...
const sampleData = [
    ...
    { id: '2', name: 'Beta Release', status: 'pending', priority: 'medium', created: '2024-01-14' },
    { id: '3', name: 'Gamma Testing', status: 'completed', priority: 'low', created: '2024-01-13' },
];
        ...
        <div className="space-y-8 p-6 bg-background text-foreground">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-lg text-muted-foreground mt-2">
                        Comprehensive showcase of ReViewPoint's UI components and design tokens
                    </p>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Buttons, notifications, and user actions</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <div className="flex flex-wrap gap-2">
                            ...
                            <Button onClick={() => handleShowNotification('error')} variant="destructive">
                                Error Toast
                            </Button>
                            <Button onClick={() => handleShowNotification('warning')} variant="outline">
                                Warning Toast
                            </Button>
                            <Button onClick={() => handleShowNotification('info')} variant="secondary">
                                Info Toast
                            </Button>
                        </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Robust form fields with validation</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <FormField
                            name="demo-name"
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Various skeleton loaders for different content types</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Consistent empty states for different scenarios</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            >
                <div className="space-y-4">
                    <p>This is a demonstration of the modal component with our design system.</p>
