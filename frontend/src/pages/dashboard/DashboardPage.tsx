import { CheckCircle, Clock, Eye, FileText, Upload } from "lucide-react";
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <Card className="hover-lift glass-card">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground flex items-center mt-1">
                <span className="text-success-foreground mr-1">+3</span> from
                last week
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="hover-lift glass-card">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground flex items-center mt-1">
                <span className="text-success-foreground mr-1">-2</span> from
                yesterday
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="hover-lift glass-card">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground flex items-center mt-1">
                <span className="text-success-foreground mr-1">+5</span> from
                last week
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {recentUploads.map((upload) => (
                  <div
                    key={upload.id}
                    className="flex items-center justify-between p-4 rounded-lg bg-muted/50 hover:bg-muted/70 transition-colors border border-border/50"
                  >
                    <div>
                      <Link
            ...
            <CardContent>
              <div className="space-y-4">
                {recentReviews.map((review) => (
                  <div
                    key={review.id}
                    className="p-4 rounded-lg bg-muted/50 hover:bg-muted/70 transition-colors border border-border/50"
                  >
