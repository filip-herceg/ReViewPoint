            ...
            <div className="container mx-auto px-6 py-8 space-y-8">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    <Card className="hover-lift glass-card">
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground flex items-center mt-1">
                                <span className="text-success-foreground mr-1">+3</span> from last week
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="hover-lift glass-card">
                        ...
                        <CardContent>
                            <div className="text-3xl font-bold text-success-foreground">{stats.completedReviews}</div>
                            <p className="text-xs text-muted-foreground flex items-center mt-1">
                                <span className="text-success-foreground mr-1">+5</span> from last week
                            </p>
                        </CardContent>
                    </Card>
