	...
	const reviews = [
		{
			...
			rating: 4,
			comments:
				"Overall good architecture design. However, I have some concerns about the scalability of the proposed microservices communication pattern.",
		...
		},
		{
			...
			rating: null,
			comments:
				"Currently reviewing the security aspects of the proposed architecture.",
					...
					{reviews.length === 0 ? (
						<div className="text-center py-8">
							...
							<p className="text-muted-foreground">
								This document hasn't been reviewed yet. Reviews will appear here
