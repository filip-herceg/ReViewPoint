...
class PerformanceMonitoringService {
    ...
    initialize(): void {
        ...
        try {
            ...
            logger.info('Performance monitoring initialized successfully', this.config);
        } catch (error) {
    ...
    private recordNavigationTiming(): void {
        if (typeof window === 'undefined' || !window.performance?.navigation) return;
...
export function usePerformanceMonitoring() {
    return {
        ...
        getPerformanceSummary: performanceMonitoringService.getPerformanceSummary.bind(performanceMonitoringService),
