...
import { themeColors, type ThemeMode } from './colors';
...
export function ThemeProvider({
    ...
    useEffect(() => {
        try {
            ...
            if (enableSystem && window.matchMedia) {
                ...
                logger.info('Theme detected from system preference', { theme: systemTheme });
                return;
            }
    ...
    useEffect(() => {
        try {
            ...
            logger.debug('Theme applied to document', { mode, colorsCount: Object.keys(colors).length });
        } catch (error) {
