...
export const usersCoreApi = {
    ...
    getUserById: async (userId: number): Promise<User> => {
        ...
        logger.info('User fetched successfully', { id: response.data!.id, email: response.data!.email });
        return response.data!;
    },

    // Update user information (admin only)
    updateUser: async (userId: number, userData: UserCreateRequest): Promise<User> => {
